...
def run_pickle(submit_config, metric_args, network_pkl, dataset_args, mirror_augment):
    ...
    metric = interfacegan.models.stylegan_tf_official.dnnlib.util.call_func_by_name(**metric_args)
    print()
...
def main():
    ...
    # Execute.
    submit_config.run_dir_root = interfacegan.models.stylegan_tf_official.dnnlib.submission.submit.get_template_from_path(
	    config.result_dir)
